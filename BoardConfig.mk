...
TARGET_BOOTLOADER_BOARD_NAME := IdeaTab_A1000-G    # From ro.product.board
...
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 22577152
...
BOARD_SUPPRESS_SECURE_ERASE := true          # Delete if your partition table has /misc
...
DEVICE_RESOLUTION := 600x12024                 # The Resolution of your Device
